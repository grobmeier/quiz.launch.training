const exam = [
  {
    ...
    correctAnswers: 1,
    explanation:
      "Autoboxing converts the Integer object to an int primitive automatically.",
  },
  {
    id: "2",
    difficulty: 2,
    ...
    correctAnswers: 3,
    explanation:
      "In Java, boolean values are either true or false, not numeric or string literals.",
  },
  {
    id: "3",
    difficulty: 3,
  ...
  },
  {
    ...
    correctAnswers: 3,
    explanation:
      "Autoboxing and unboxing work with all primitive types and their corresponding wrappers. Unboxing can throw a NullPointerException if the wrapper object is null.",
  },
  {
    id: "5",
    difficulty: 2,
    ...
    correctAnswers: 2,
    explanation:
      "Boolean variables are initialized using the literals true or false, optionally enclosed in parentheses.",
  },
  {
    id: "6",
    difficulty: 3,
    ...
    correctAnswers: 3,
    explanation:
      "Autoboxing can be done using assignment, Integer.valueOf(), or the new Integer() constructor.",
  },
  {
    id: "7",
    difficulty: 1,
    ...
    correctAnswers: 1,
    explanation:
      "The code concatenates the int value with the string and prints it directly.",
  },
  {
    id: "8",
    difficulty: 3,
    ...
    correctAnswers: 1,
    explanation:
      "Unboxing converts the Boolean object to a boolean primitive automatically.",
  },
  {
    id: "9",
    difficulty: 2,
    ...
    correctAnswers: 3,
    explanation:
      "Strings in Java can be initialized using double quotes directly or by creating a new String object.",
  },
  {
    id: "10",
    difficulty: 4,
    ...
    correctAnswers: 1,
    explanation:
      "The Integer.valueOf() method converts the int primitive to an Integer object, which is then concatenated with the string.",
  },
  {
    id: "11",
    difficulty: 1,
    ...
    correctAnswers: 3,
    explanation:
      "Temperature can be represented as an int, Integer, or String, but not as a boolean or Boolean.",
  },
  {
    id: "12",
    difficulty: 3,
    ...
    correctAnswers: 1,
    explanation:
      "The string value is concatenated directly with the other string and printed.",
  },
  {
    id: "13",
    difficulty: 4,
    ...
    correctAnswers: 3,
    explanation:
      "int is a signed integer with a default value of 0, and boolean can only hold true or false.",
  },
  {
    id: "14",
    difficulty: 2,
    ...
    correctAnswers: 4,
    explanation:
      "String operations like toUpperCase(), charAt(), equals(), and concat() are valid in Java, but size() is not a method for String.",
  },
  {
    id: "15",
    difficulty: 5,
    ...
    correctAnswers: 1,
    explanation:
      "The toUpperCase() method returns a new string, the old string in the plutoStatus variable stays unchanged: Strings are immutable",
  },
  {
    id: "16",
    difficulty: 2,
    ...
    correctAnswers: 1,
    explanation:
      "Autoboxing converts the int primitive to an Integer object automatically.",
  },
  {
    id: "17",
    difficulty: 3,
    ...
    correctAnswers: 3,
    explanation:
      "Wrapper classes provide object representations of primitives, can be null, have methods, are part of java.lang, and include classes like Integer, Boolean, and Double.",
  },
  {
    id: "18",
    difficulty: 4,
    ...
    correctAnswers: 1,
    explanation:
      "Null values cannot be converted, a NullPointerException will be thrown",
  },
  {
    id: "19",
    difficulty: 3,
  ...
  },
  {
    ...
    type: "code",
    content:
      'String saturnRings = "Beautiful".toUpperCase();\nSystem.out.println("Saturns rings are " + saturnRings);\n',
    language: "java",
    answers: [
      {
        text: "Saturns rings are Beautiful",
